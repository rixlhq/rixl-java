package com.rixl.sdk.analytics.v1.top.images;
...
import com.rixl.sdk.models.analytics.v1.TopImagesResponse;
...
public class ImagesRequestBuilder extends BaseRequestBuilder {
    ...
    public ImagesRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/analytics/v1/top/images{?limit*,range%2Eend*,range%2Estart*}", pathParameters);
    }
    /**
     * Instantiates a new {@link ImagesRequestBuilder} and sets the default values.
    ...
    public ImagesRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/analytics/v1/top/images{?limit*,range%2Eend*,range%2Estart*}", rawUrl);
    }
    /**
     * GetTopImages
     * @return a {@link TopImagesResponse}
     */
    @jakarta.annotation.Nullable
    public TopImagesResponse get() {
        return get(null);
    }
    /**
     * GetTopImages
     ...
     */
    @jakarta.annotation.Nullable
    public TopImagesResponse get(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = toGetRequestInformation(requestConfiguration);
        return this.requestAdapter.send(requestInfo, null, TopImagesResponse::createFromDiscriminatorValue);
    }
    /**
     * GetTopImages
