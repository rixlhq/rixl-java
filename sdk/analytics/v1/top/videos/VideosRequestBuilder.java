package com.rixl.sdk.analytics.v1.top.videos;
...
import com.rixl.sdk.models.analytics.v1.TopVideosResponse;
...
public class VideosRequestBuilder extends BaseRequestBuilder {
    ...
    public VideosRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/analytics/v1/top/videos{?limit*,range%2Eend*,range%2Estart*}", pathParameters);
    }
    /**
     * Instantiates a new {@link VideosRequestBuilder} and sets the default values.
    ...
    public VideosRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/analytics/v1/top/videos{?limit*,range%2Eend*,range%2Estart*}", rawUrl);
    }
    /**
     * GetTopVideos
     ...
     */
    @jakarta.annotation.Nullable
    public TopVideosResponse get(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = toGetRequestInformation(requestConfiguration);
        return this.requestAdapter.send(requestInfo, null, TopVideosResponse::createFromDiscriminatorValue);
    }
    /**
     * GetTopVideos
