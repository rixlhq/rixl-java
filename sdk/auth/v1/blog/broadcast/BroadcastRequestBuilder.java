...
import com.rixl.sdk.models.auth.v1.SendBlogBroadcastRequest;
import com.rixl.sdk.models.auth.v1.SendBlogBroadcastResponse;
...
public class BroadcastRequestBuilder extends BaseRequestBuilder {
    ...
    public SendBlogBroadcastResponse post(@jakarta.annotation.Nonnull final SendBlogBroadcastRequest body) {
     ...
     */
    @jakarta.annotation.Nullable
    public SendBlogBroadcastResponse post(@jakarta.annotation.Nonnull final SendBlogBroadcastRequest body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
    ...
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final SendBlogBroadcastRequest body) {
     ...
     */
    @jakarta.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final SendBlogBroadcastRequest body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
