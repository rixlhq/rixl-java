package com.rixl.sdk.auth.v1.users.current.avatar.upload;
...
import com.rixl.sdk.models.auth.v1.CreateAvatarUploadResponse;
...
public class UploadRequestBuilder extends BaseRequestBuilder {
    ...
    public UploadRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/auth/v1/users/current/avatar/upload{?user_id*}", pathParameters);
    }
    /**
     * Instantiates a new {@link UploadRequestBuilder} and sets the default values.
    ...
    public UploadRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/auth/v1/users/current/avatar/upload{?user_id*}", rawUrl);
    }
    /**
     * CreateAvatarUpload
     * @return a {@link CreateAvatarUploadResponse}
     */
    @jakarta.annotation.Nullable
    public CreateAvatarUploadResponse post() {
        return post(null);
    }
    /**
     * CreateAvatarUpload
     ...
     */
    @jakarta.annotation.Nullable
    public CreateAvatarUploadResponse post(@jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = toPostRequestInformation(requestConfiguration);
        return this.requestAdapter.send(requestInfo, null, CreateAvatarUploadResponse::createFromDiscriminatorValue);
    }
    /**
     * CreateAvatarUpload
