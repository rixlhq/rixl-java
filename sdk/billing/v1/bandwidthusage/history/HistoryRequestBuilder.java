package com.rixl.sdk.billing.v1.bandwidthusage.history;
...
import com.rixl.sdk.models.billing.v1.GetBandwidthUsageHistoryResponse;
...
public class HistoryRequestBuilder extends BaseRequestBuilder {
    ...
    public HistoryRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/billing/v1/bandwidth-usage/history{?days*,org_id*}", pathParameters);
    }
    /**
     * Instantiates a new {@link HistoryRequestBuilder} and sets the default values.
    ...
    public HistoryRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/billing/v1/bandwidth-usage/history{?days*,org_id*}", rawUrl);
    }
    /**
    ...
    public GetBandwidthUsageHistoryResponse get() {
        return get(null);
    }
    /**
     * GetBandwidthUsageHistory
     ...
     */
    @jakarta.annotation.Nullable
    public GetBandwidthUsageHistoryResponse get(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = toGetRequestInformation(requestConfiguration);
        return this.requestAdapter.send(requestInfo, null, GetBandwidthUsageHistoryResponse::createFromDiscriminatorValue);
    }
    /**
     * GetBandwidthUsageHistory
