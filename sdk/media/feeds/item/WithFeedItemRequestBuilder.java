package com.rixl.sdk.media.feeds.item;
...
import com.rixl.sdk.media.feeds.item.creators.CreatorsRequestBuilder;
import com.rixl.sdk.media.feeds.item.item.WithPostItemRequestBuilder;
...
import com.rixl.sdk.models.github_com_rixlhq_api_internal_feeds_types.UpdateFeedRequest;
...
public class WithFeedItemRequestBuilder extends BaseRequestBuilder {
    ...
    /**
     * Gets an item from the com.rixl.sdk.media.feeds.item.item collection
    ...
    public WithFeedItemRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/media/feeds/{feedId}{?limit*,offset*}", pathParameters);
    }
    /**
     * Instantiates a new {@link WithFeedItemRequestBuilder} and sets the default values.
    ...
    public WithFeedItemRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/media/feeds/{feedId}{?limit*,offset*}", rawUrl);
    }
    /**
     * Deletes a feed in the active project.
     * @param body The request body
     * @return a {@link WithFeedDeleteResponse}
    ...
    public WithFeedDeleteResponse delete(@jakarta.annotation.Nonnull final WithFeedDeleteRequestBody body) {
     ...
     */
    @jakarta.annotation.Nullable
    public WithFeedDeleteResponse delete(@jakarta.annotation.Nonnull final WithFeedDeleteRequestBody body, @jakarta.annotation.Nullable final java.util.function.Consumer<DeleteRequestConfiguration> requestConfiguration) {
        ...
        return this.requestAdapter.send(requestInfo, errorMapping, WithFeedDeleteResponse::createFromDiscriminatorValue);
    }
    /**
     ...
     */
    @jakarta.annotation.Nullable
    public FeedResponse put(@jakarta.annotation.Nonnull final UpdateFeedRequest body) {
     ...
     */
    @jakarta.annotation.Nullable
    public FeedResponse put(@jakarta.annotation.Nonnull final UpdateFeedRequest body, @jakarta.annotation.Nullable final java.util.function.Consumer<PutRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
