package com.rixl.sdk.media.images.item;
...
public class WithImageItemRequestBuilder extends BaseRequestBuilder {
    ...
    public WithImageItemRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/media/images/{imageId}", pathParameters);
    }
    /**
     * Instantiates a new {@link WithImageItemRequestBuilder} and sets the default values.
    ...
    public WithImageItemRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/media/images/{imageId}", rawUrl);
    }
    /**
     * Soft delete an image by ID (marks it as deleted).
     * @return a {@link WithImageDeleteResponse}
    ...
    public WithImageDeleteResponse delete() {
        return delete(null);
    }
    /**
     * Soft delete an image by ID (marks it as deleted).
     ...
     */
    @jakarta.annotation.Nullable
    public WithImageDeleteResponse delete(@jakarta.annotation.Nullable final java.util.function.Consumer<DeleteRequestConfiguration> requestConfiguration) {
        ...
        return this.requestAdapter.send(requestInfo, errorMapping, WithImageDeleteResponse::createFromDiscriminatorValue);
    }
    /**
