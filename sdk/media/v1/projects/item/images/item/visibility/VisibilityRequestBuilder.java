...
public class VisibilityRequestBuilder extends BaseRequestBuilder {
    ...
    public VisibilityRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/media/v1/projects/{projectId}/images/{imageId}/visibility", pathParameters);
    }
    /**
     * Instantiates a new {@link VisibilityRequestBuilder} and sets the default values.
    ...
    public VisibilityRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/media/v1/projects/{projectId}/images/{imageId}/visibility", rawUrl);
    }
    /**
    ...
    public GetImageResponse put(@jakarta.annotation.Nonnull final UpdateVisibilityBody body) {
     ...
     */
    @jakarta.annotation.Nullable
    public GetImageResponse put(@jakarta.annotation.Nonnull final UpdateVisibilityBody body, @jakarta.annotation.Nullable final java.util.function.Consumer<PutRequestConfiguration> requestConfiguration) {
