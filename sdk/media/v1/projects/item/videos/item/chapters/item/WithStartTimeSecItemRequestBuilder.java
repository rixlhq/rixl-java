package com.rixl.sdk.media.v1.projects.item.videos.item.chapters.item;
...
public class WithStartTimeSecItemRequestBuilder extends BaseRequestBuilder {
     ...
     */
    @jakarta.annotation.Nonnull
    public WithStartTimeSecItemRequestBuilder withUrl(@jakarta.annotation.Nonnull final String rawUrl) {
        Objects.requireNonNull(rawUrl);
        return new WithStartTimeSecItemRequestBuilder(rawUrl, requestAdapter);
    }
    /**
