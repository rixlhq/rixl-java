...
public class Widget implements Parsable {
    /**
    ...
    public static Widget createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("spec_version", (n) -> { this.setSpecVersion(n.getIntegerValue()); });
     ...
     * @param value Value to set for the spec_version property.
     */
    public void setSpecVersion(@jakarta.annotation.Nullable final Integer value) {
