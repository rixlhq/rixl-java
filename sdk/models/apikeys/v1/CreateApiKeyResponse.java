...
public class CreateApiKeyResponse implements Parsable {
    /**
    ...
    public static CreateApiKeyResponse createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
