...
public class CreateAvatarUploadResponse implements Parsable {
    /**
    ...
    public static CreateAvatarUploadResponse createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
