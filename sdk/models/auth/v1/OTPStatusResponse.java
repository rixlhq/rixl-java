...
public class OTPStatusResponse implements Parsable {
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("isSetup", (n) -> { this.setIsSetup(n.getBooleanValue()); });
        return deserializerMap;
    }
    /**
     * Gets the isSetup property value. The isSetup property
    ...
    public void serialize(@jakarta.annotation.Nonnull final SerializationWriter writer) {
        ...
        writer.writeBooleanValue("isSetup", this.getIsSetup());
    }
    /**
    ...
    /**
     * Sets the isSetup property value. The isSetup property
     * @param value Value to set for the isSetup property.
     */
