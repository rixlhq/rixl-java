...
public class UpdateUserAvatarResponse implements Parsable {
    /**
    ...
    public static UpdateUserAvatarResponse createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
