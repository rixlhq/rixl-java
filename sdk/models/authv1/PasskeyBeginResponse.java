...
public class PasskeyBeginResponse implements AdditionalDataHolder, Parsable {
    /**
     ...
     */
    private java.util.List<Integer> options;
    /**
     * The session_id property
     */
    private String sessionId;
    /**
     * Instantiates a new {@link PasskeyBeginResponse} and sets the default values.
     */
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("options", (n) -> { this.setOptions(n.getCollectionOfPrimitiveValues(Integer.class)); });
    ...
    public java.util.List<Integer> getOptions() {
        return this.options;
    }
    /**
     ...
     */
    public void setOptions(@jakarta.annotation.Nullable final java.util.List<Integer> value) {
        this.options = value;
    }
    /**
