...
public class StorageUsage implements Parsable {
     ...
     */
    private String imageStorageBytes;
    /**
     ...
     */
    private String videoStorageBytes;
    /**
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("image_storage_bytes", (n) -> { this.setImageStorageBytes(n.getStringValue()); });
        ...
        deserializerMap.put("total_storage_bytes", (n) -> { this.setTotalStorageBytes(n.getStringValue()); });
        ...
        deserializerMap.put("video_storage_bytes", (n) -> { this.setVideoStorageBytes(n.getStringValue()); });
     ...
     */
    @jakarta.annotation.Nullable
    public String getImageStorageBytes() {
     ...
     */
    @jakarta.annotation.Nullable
    public String getVideoStorageBytes() {
     ...
     */
    public void setImageStorageBytes(@jakarta.annotation.Nullable final String value) {
     ...
     */
    public void setTotalStorageBytes(@jakarta.annotation.Nullable final String value) {
     ...
     */
    public void setVideoStorageBytes(@jakarta.annotation.Nullable final String value) {
