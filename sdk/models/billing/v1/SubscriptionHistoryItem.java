...
public class SubscriptionHistoryItem implements Parsable {
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("end_date", (n) -> { this.setEndDate(n.getOffsetDateTimeValue()); });
        ...
        deserializerMap.put("start_date", (n) -> { this.setStartDate(n.getOffsetDateTimeValue()); });
    ...
    public void serialize(@jakarta.annotation.Nonnull final SerializationWriter writer) {
        ...
        writer.writeOffsetDateTimeValue("end_date", this.getEndDate());
        ...
        writer.writeOffsetDateTimeValue("start_date", this.getStartDate());
