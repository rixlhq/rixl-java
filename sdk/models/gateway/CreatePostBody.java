...
public class CreatePostBody implements AdditionalDataHolder, Parsable {
    /**
     ...
     * The type property
     */
    private CreatePostBodyType type;
    /**
     * The video_id property
     */
    private String videoId;
    /**
     * Instantiates a new {@link CreatePostBody} and sets the default values.
     */
     ...
     * @return a {@link CreatePostBody}
     */
    @jakarta.annotation.Nonnull
    public static CreatePostBody createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("type", (n) -> { this.setType(n.getEnumValue(CreatePostBodyType::forValue)); });
     ...
     * @return a {@link CreatePostBodyType}
     */
    @jakarta.annotation.Nullable
    public CreatePostBodyType getType() {
        return this.type;
    }
    /**
     ...
     */
    public void setType(@jakarta.annotation.Nullable final CreatePostBodyType value) {
        this.type = value;
    }
    /**
