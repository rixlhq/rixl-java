...
public class PaginatedResponseGithubComRixlhqApiInternalFeedsTypesFeedResponse implements AdditionalDataHolder, Parsable {
    /**
     ...
     */
    private java.util.List<FeedResponse> data;
    /**
     * Pagination data for the request.
     */
    private Pagination pagination;
    /**
     * Instantiates a new {@link PaginatedResponseGithubComRixlhqApiInternalFeedsTypesFeedResponse} and sets the default values.
     */
    public PaginatedResponseGithubComRixlhqApiInternalFeedsTypesFeedResponse() {
    ...
    public static PaginatedResponseGithubComRixlhqApiInternalFeedsTypesFeedResponse createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new PaginatedResponseGithubComRixlhqApiInternalFeedsTypesFeedResponse();
    }
    /**
     ...
     * @return a {@link java.util.List<FeedResponse>}
     */
    @jakarta.annotation.Nullable
    public java.util.List<FeedResponse> getData() {
        return this.data;
    }
    /**
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("data", (n) -> { this.setData(n.getCollectionOfObjectValues(FeedResponse::createFromDiscriminatorValue)); });
     ...
     */
    public void setData(@jakarta.annotation.Nullable final java.util.List<FeedResponse> value) {
        this.data = value;
    }
    /**
