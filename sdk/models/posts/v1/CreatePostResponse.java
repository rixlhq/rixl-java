...
public class CreatePostResponse implements Parsable {
    /**
     * The post property
     */
    private Post post;
    ...
    public static CreatePostResponse createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
