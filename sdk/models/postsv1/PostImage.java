...
public class PostImage implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link PostImage} and sets the default values.
     */
    public PostImage() {
    ...
    public static PostImage createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
