...
public class PostVideo implements AdditionalDataHolder, Parsable {
    /**
     ...
     * The poster property
     */
    private PostImage poster;
    /**
     * The width property
     */
    private Integer width;
    /**
     * Instantiates a new {@link PostVideo} and sets the default values.
     */
    public PostVideo() {
    ...
    public static PostVideo createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("file", (n) -> { this.setFile(n.getObjectValue(PostFile::createFromDiscriminatorValue)); });
        ...
        deserializerMap.put("poster", (n) -> { this.setPoster(n.getObjectValue(PostImage::createFromDiscriminatorValue)); });
     ...
     */
    public void setFile(@jakarta.annotation.Nullable final PostFile value) {
        this.file = value;
    }
    /**
     ...
     */
    public void setPoster(@jakarta.annotation.Nullable final PostImage value) {
        this.poster = value;
    }
    /**
