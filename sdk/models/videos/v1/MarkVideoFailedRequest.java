...
public class MarkVideoFailedRequest implements Parsable {
    /**
     ...
     * @return a {@link MarkVideoFailedRequest}
     */
    @jakarta.annotation.Nonnull
    public static MarkVideoFailedRequest createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new MarkVideoFailedRequest();
    }
    /**
