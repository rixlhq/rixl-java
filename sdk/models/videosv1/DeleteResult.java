...
public class DeleteResult implements AdditionalDataHolder, Parsable {
    /**
    ...
    private String id;
    /**
     * Instantiates a new {@link DeleteResult} and sets the default values.
     */
    public DeleteResult() {
    ...
    public static DeleteResult createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
