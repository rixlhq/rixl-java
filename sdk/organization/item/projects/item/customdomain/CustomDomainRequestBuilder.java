package com.rixl.sdk.organization.item.projects.item.customdomain;
...
import com.rixl.sdk.models.types.CustomDomainRequest;
...
public class CustomDomainRequestBuilder extends BaseRequestBuilder {
    ...
    public CustomDomainRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/organization/{orgId}/projects/{projectId}/custom-domain", pathParameters);
    }
    /**
     * Instantiates a new {@link CustomDomainRequestBuilder} and sets the default values.
    ...
    public CustomDomainRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/organization/{orgId}/projects/{projectId}/custom-domain", rawUrl);
    }
    /**
     ...
     */
    @jakarta.annotation.Nullable
    public Project put(@jakarta.annotation.Nonnull final CustomDomainRequest body) {
     ...
     */
    @jakarta.annotation.Nullable
    public Project put(@jakarta.annotation.Nonnull final CustomDomainRequest body, @jakarta.annotation.Nullable final java.util.function.Consumer<PutRequestConfiguration> requestConfiguration) {
     ...
     */
    @jakarta.annotation.Nonnull
    public RequestInformation toPutRequestInformation(@jakarta.annotation.Nonnull final CustomDomainRequest body) {
     ...
     */
    @jakarta.annotation.Nonnull
    public RequestInformation toPutRequestInformation(@jakarta.annotation.Nonnull final CustomDomainRequest body, @jakarta.annotation.Nullable final java.util.function.Consumer<PutRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
