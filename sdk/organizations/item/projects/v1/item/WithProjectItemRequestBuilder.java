package com.rixl.sdk.organizations.item.projects.v1.item;
...
import com.rixl.sdk.organizations.item.projects.v1.item.customdomain.CustomDomainRequestBuilder;
import com.rixl.sdk.organizations.item.projects.v1.item.move.MoveRequestBuilder;
import com.rixl.sdk.organizations.item.projects.v1.item.name.NameRequestBuilder;
import com.rixl.sdk.organizations.item.projects.v1.item.videoquality.VideoQualityRequestBuilder;
...
public class WithProjectItemRequestBuilder extends BaseRequestBuilder {
    ...
    public WithProjectItemRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/organizations/{org_id}/projects/v1/{project_id}", pathParameters);
    }
    /**
     * Instantiates a new {@link WithProjectItemRequestBuilder} and sets the default values.
    ...
    public WithProjectItemRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/organizations/{org_id}/projects/v1/{project_id}", rawUrl);
    }
    /**
     * DeleteProject
