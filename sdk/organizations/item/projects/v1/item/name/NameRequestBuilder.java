...
public class NameRequestBuilder extends BaseRequestBuilder {
    ...
    public NameRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/organizations/{org_id}/projects/v1/{project_id}/name", pathParameters);
    }
    /**
     * Instantiates a new {@link NameRequestBuilder} and sets the default values.
    ...
    public NameRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/organizations/{org_id}/projects/v1/{project_id}/name", rawUrl);
    }
    /**
     * UpdateProjectName
    ...
    public Project patch(@jakarta.annotation.Nonnull final NamePatchRequestBody body) {
     ...
     */
    @jakarta.annotation.Nullable
    public Project patch(@jakarta.annotation.Nonnull final NamePatchRequestBody body, @jakarta.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) {
