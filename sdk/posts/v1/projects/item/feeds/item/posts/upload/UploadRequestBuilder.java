...
import com.rixl.sdk.models.posts.v1.PostUpload;
...
public class UploadRequestBuilder extends BaseRequestBuilder {
    ...
    public PostUpload post(@jakarta.annotation.Nonnull final UploadPostRequestBody body) {
     ...
     */
    @jakarta.annotation.Nullable
    public PostUpload post(@jakarta.annotation.Nonnull final UploadPostRequestBody body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = toPostRequestInformation(body, requestConfiguration);
        return this.requestAdapter.send(requestInfo, null, PostUpload::createFromDiscriminatorValue);
    }
    /**
     * CreatePostUpload
     * @param body The request body
