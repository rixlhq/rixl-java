...
public class WithTrackItemRequestBuilder extends BaseRequestBuilder {
    ...
    public WithTrackItemRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/videos/{videoId}/audio-tracks/{trackId}", pathParameters);
    }
    /**
     * Instantiates a new {@link WithTrackItemRequestBuilder} and sets the default values.
    ...
    public WithTrackItemRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/videos/{videoId}/audio-tracks/{trackId}", rawUrl);
    }
    /**
    ...
    public AudioTrackDelete delete(@jakarta.annotation.Nullable final java.util.function.Consumer<DeleteRequestConfiguration> requestConfiguration) {
        ...
        return this.requestAdapter.send(requestInfo, errorMapping, AudioTrackDelete::createFromDiscriminatorValue);
    }
    /**
     * Remove an additional audio track from a video using API key authentication
